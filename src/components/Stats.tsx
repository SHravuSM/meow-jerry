    ...
    <div className={cn("flex flex-col items-center gap-4", className)}>
      <div className="flex items-center justify-between gap-8">
        <div className="text-center">
          ...
          <div
            ref={wpmRef}
            className="text-4xl font-mono font-semibold transition-colors"
          >
            {wpm}
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="text-4xl font-mono font-semibold">{accuracy}%</div>
        </div>
        ...
        {time !== undefined && maxTime !== undefined && (
          <div className="text-center">
            ...
            <div className="text-4xl font-mono font-semibold">{time}s</div>
      ...
      {showRestart && (
        ...
        <div>
          Press{" "}
          <kbd onClick={onRestart} className="px-2 py-0.5 bg-primary/20 rounded font-semibold text-primary mx-1 border border-primary/30">
            Esc
          </kbd>{" "}
          to restart test
        </div>
